...
rule1 = Rule(symbol="asdf", targetLiteral=r"111111111111%1 1111111111111111111%311111111")
repo.register(rule1)
rule2 = Rule(symbol="1", targetLiteral=r"q q q q q q q q q q q qq q q qq q  q")
repo.register(rule2)
rule3 = Rule(symbol="123345", targetLiteral=r"q q q q q q q q q q q qq q q qq q %1  q")
repo.register(rule3)
